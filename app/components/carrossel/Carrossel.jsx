...
const projects = [
    ...
    },
    {
        ...
        category: "Instagram",
        cover: imgHeroCards,
        images: [imgHeroCards, imgPolaroid, imgBackground, imgBackground2],
    },
];
...
export default function Carrossel() {
    ...
    useEffect(() => {
        ...
        const update = () => {
            ...
            setIndex((i) => Math.min(i, Math.max(0, projects.length - nextPerView)));
        };
        update();
    ...
    return (
        <section id="portfolio" className="w-full overflow-hidden bg-black py-16 max-md:py-12">
            <div className="mx-auto max-w-[1200px] px-6 max-md:px-5">
                ...
                <motion.div initial={{ scale: 0, x: 100 }}
            ...
            {selectedProject && (
                <div
                    className={`fixed inset-0 z-[1000] animate-[overlayIn_0.35s_ease_backwards] bg-black/[0.94] ${isClosing ? "pointer-events-none opacity-0 [transition:opacity_0.45s_ease]" : ""
                        }`}
                    role="dialog"
                    aria-modal="true"
                    ...
                    {selectedProject && !showAll && (
                        <>
                            ...
                            >
                                ...
                                />
                                <div
                                    className={`pointer-events-none absolute bottom-[18px] left-5 flex flex-col gap-0.5 opacity-0 [text-shadow:0_1px_10px_rgba(0,0,0,0.9)] [transition:opacity_0.4s_ease_0.4s] ${isExpanded ? "opacity-100" : ""
                                        }`}
                                >
